...
<div id="logo"><a href="/search_engine/search.jsp"><img src="logo0.png"  style="height:44px; width:100px; "></a></div>
<div id="search">
...
<div class = "row-fluid" id="resultBody">
	...
	<%if(suggestions!=null && suggestions.length>0){
		  	...
		  	for(int i=0; i < suggestions.length;i++){ %>
		  		<a  href="/SixerSearcher/servlet/Server?query=<%= suggestions[i] %>&Submit=Search">
		  		<%= suggestions[i] %> 
		  		</a>
	  			<br/>
		  	<% }
