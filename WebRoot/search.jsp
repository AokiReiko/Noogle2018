...
<title>AtTsinghua</title>
  <!-- bootstrap -->
    ...
    <link href="servlet/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
    <link href="servlet/bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
    <script src="servlet/jquery.min.js"></script>
  <script src="servlet/bootstrap/js/bootstrap.min.js"></script>
  <script src="servlet/util.js"></script>
  <script src="servlet/bootstrap/js/material.min.js"></script>
...
<body>
  ...
  <div style="height:30px;margin-top:60px" >
    ...
    <div>
    <h1 height="220"><img src="servlet/logo0.png" width="400" height="220"></h1>
